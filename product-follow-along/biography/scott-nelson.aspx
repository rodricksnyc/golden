<%@ Page Title="Farmer Biography – Scott Nelson | Golden Harvest" Language="C#" MasterPageFile="~/Template/GoldenHarvest.Master" AutoEventWireup="true" CodeBehind="scott-nelson.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="Farmer Scott Nelson shares his agronomy and agriculture experience growing Golden Harvest® corn seeds." />
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-md-push-2">
                    <ul>
                        ...
                        &gt;
                        <li><a href="<%=ResolveUrl("../blogs/scott-nelson.aspx") %>">Farmer Bio</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12 col-md-10 col-md-push-1">
                    <div class="farmer-bio">
                        <div class="farmer-img">
                            <img src="<%=ResolveUrl("../img/farmers/248x248.png")%>" alt="Scott Nelson"/>
                        </div>
                        <div class="farmer-content">
                            <h2>Scott Nelson</h2>
                            <p><b>Golden Harvest farmer</b></p>
                            <p><b>Lancaster, MN</b></p>
                            <p>Scott Nelson is a 30-year veteran of the farming industry, growing corn, soybeans and cereals among other crops on his Lancaster, Minn., farm. Scott has planted Golden Harvest<sup>&reg;</sup> seeds for two years, and this season, he will share his experiences with E080Q1-5122A E-Z Refuge<sup>&reg;</sup> seed, an Enogen<sup>&reg;</sup> corn hybrid.</p>
                        </div>
                    </div>
                </div>
            </div>

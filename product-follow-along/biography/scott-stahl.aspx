<%@ Page Title="Farmer Biography – Scott Stahl | Golden Harvest" Language="C#" MasterPageFile="~/Template/GoldenHarvest.Master" AutoEventWireup="true" CodeBehind="scott-stahl.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="Farmer Scott Stahl shares his agronomy and agriculture experience growing Golden Harvest® corn seeds." />
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-md-push-2">
                    <ul>
                        ...
                        &gt;
                        <li><a href="<%=ResolveUrl("../blogs/scott-stahl.aspx") %>">Farmer Bio</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12 col-md-10 col-md-push-1">
                    <div class="farmer-bio">
                        <div class="farmer-img">
                            <img src="<%=ResolveUrl("../img/farmers/scott-stahl-248x248.jpg") %>" alt="Scott Stahl"/>
                        </div>
                        <div class="farmer-content">
                            <h2>Scott Stahl</h2>
                            <p><b>Golden Harvest farmer</b></p>
                            <p><b>Bridgewater, SD</b></p>
                            <p>Scott Stahl has been farming for 12 years, and he has planted Golden Harvest<sup>&reg;</sup> seeds each of those years. This season, Scott will share the experiences he has with G10L16-5222A E-Z Refuge<sup>&reg;</sup> seed an G11V76-5122 E-Z Refuge seed, both Golden Harvest corn hybrids, on his Bridgewater, S.D., farm.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-post">
                        <div class="blog-img">
                            <a href="<%=ResolveUrl("../blogs/scott-stahl/planting-corn-hybrids-in-sd.aspx") %>">
                                <img src="<%=ResolveUrl("../img/thumbnails/planting-corn-hybrids-in-sd-200x126.jpg") %>" />
                            </a>
                        </div>
                        <div class="blog-content">
                            <a href="<%=ResolveUrl("../blogs/scott-stahl/planting-corn-hybrids-in-sd.aspx") %>">Planting G10L16 and G11V76 corn hybrids in Bridgewater, S.D.</a>
                            <p>In the 12 years he's been farming, Scott Stahl has always planted Golden Harvest<sup>&reg;</sup> seeds on his Bridgewater, S.D., farm. Follow along as long-time Golden Harvest customer Scott gives updates on the corn hybrids he planted this season: G10L16-5222A E-Z Refuge<sup>&reg;</sup> seed and G11V76-5122 E-Z Refuge seed.</p>
                        </div>
                    </div>
                </div>
            </div>

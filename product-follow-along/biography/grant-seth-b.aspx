<%@ Page Title="Farmer Biography – Grant and Seth B. | Golden Harvest" Language="C#" MasterPageFile="~/Template/GoldenHarvest.Master" AutoEventWireup="true" CodeBehind="grant-seth-b.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta name="description" content="Farmers Grant and Seth B. shares their agronomy and agriculture experience growing Golden Harvest® soybean seeds." />
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-md-push-2">
                    <ul>
                        ...
                        &gt;
                        <li><a href="<%=ResolveUrl("../blogs/grant-seth-b.aspx") %>">Farmer Bio</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12 col-md-10 col-md-push-1">
                    <div class="farmer-bio">
                        <div class="farmer-img">
                            <img src="<%=ResolveUrl("../img/farmers/248x248.png")%>" alt="Grant and Seth B." />
                        </div>
                        <div class="farmer-content">
                            <h2>Grant and Seth B.</h2>
                            <p><b>Golden Harvest farmers</b></p>
                            <p><b>Windsor, ND</b></p>
                            <p>Grant and Seth B. have been farming for 30 years, and this is their first season planting Golden Harvest<sup>&reg;</sup> seeds. Grant and Seth will share their experiences with Golden Harvest soybean GH0502XF, with the XtendFlex<sup>&reg;</sup> soybean trait platform, from their Windsor, N.D., farm.</p>
                        </div>
                    </div>
                </div>
            </div>
